...
description: "Hitting Internet Explorer's 4095-selector limit and wiring the Bless node module into a Compass build to split oversized CSS files automatically."
